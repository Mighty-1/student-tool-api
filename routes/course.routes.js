...
router.get('/get-courses-by-institute', courseController.getCourses); // for query param
router.get('/get-courses-by-institute/:instituteId', courseController.getCourses);
